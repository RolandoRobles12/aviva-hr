...
export function hubLabel(id: string): string {
  return regions.find((h) => h.id === id)?.label ?? id;
}
...
export const candidates: Candidate[] = [
  ...
  },
  {
    ...
    region:"hub3_region-pue-mor-tlax",
    quiosco: "Texmelucan",
    estado: "Puebla",
    stage: "contract_sent",
    recruiter: "Lyz Nuñez",
...
export const users: User[] = [
  {
    ...
    role: "CEO",
    region:"corporativo", quiosco: "Aviva House", estado: "CDMX",
  ...
  },
  {
    ...
    region:"hub1-region_hidalgo", quiosco: "Tulancingo", estado: "Hidalgo",
  ...
  },
  {
    ...
    role: "Growth Hub Manager",
    region:"hub2-region_edomex", quiosco: "Ixtapaluca", estado: "México",
    empresa: "Aviva Crédito",
    genero: "H", talla: "L",
    manager: "u-001_02", managerName: "Andrés Rizo Mendoza",
  ...
  },
  {
    ...
    role: "Growth Hub Manager",
    region:"hub3_region-pue-mor-tlax", quiosco: "Texmelucan", estado: "Puebla",
    empresa: "Aviva Crédito",
    genero: "M", talla: "S",
    manager: "u-001_02", managerName: "Andrés Rizo Mendoza",
  ...
  },
  {
    ...
    region:"hub1-region_hidalgo", quiosco: "Actopan", estado: "Hidalgo",
    empresa: "Aviva Crédito",
    genero: "H", talla: "M",
