...
const ALL_SCOPES = [
  ...
  { id: "locations:read",    label: "Leer locaciones",      desc: "GET /locations, GET /locations/:id" },
  { id: "locations:write",   label: "Crear y editar locaciones", desc: "POST /locations, PATCH /locations/:id" },
  { id: "locations:delete",  label: "Eliminar locaciones",  desc: "DELETE /locations/:id" },
